        ...
        output.body = {
          ...
          bookingInfo: {
            ...
            vehicleEntry: {
              ...
              value: booking.vehicleEntry != null ? moment(booking.vehicleEntry).format('YYYY/M/D H:m') : '',
            },
            vehicleExit: {
              label: 'Salida del vehículo',
              value: booking.vehicleExit != null ? moment(booking.vehicleExit).format('YYYY/M/D H:m') : '-',
            },
          },
        };
